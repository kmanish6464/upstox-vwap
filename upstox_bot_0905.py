...
Usage:
  python nifty_trading_bot.py backtest
  python nifty_trading_bot.py live
"""
...
def print_help():
    print(
        "\nUsage:\n"
        "  python nifty_trading_bot.py backtest   # Run historical backtest\n"
        "  python nifty_trading_bot.py live       # Run live paper trade\n\n"
        "Configuration:\n"
        "  Edit config.ini to set zones, levels, keys, and timeframe.\n"
    )
